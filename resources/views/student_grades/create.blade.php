...
@section('title', $title . ' - Sistema Escolar')
...
<div class="d-flex justify-content-between align-items-center welcome-header">
    <div>
        ...
        <p class="text-secondary">Completa los datos de la calificación</p>
    </div>
</div>
...
<div class="section-card">
    <div class="card-body">
        ...
        <form action="{{ isset($grade) ? route('student-grades.update', $grade->id) : route('student-grades.store') }}" method="POST">
            @csrf
            @if(isset($grade))
                @method('PUT')
            @endif
            ...
            <div class="mt-4">
                <div class="btn-group" role="group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>{{ isset($grade) ? 'Actualizar' : 'Guardar' }}
                    </button>
