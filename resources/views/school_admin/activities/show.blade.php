                    ...
                    <div class="row mb-4">
                        <div class="col-md-8">
                            ...
                            @if($activity->resource_assignment)
                                <hr>
                                <h5 class="text-muted">Asignación de Recursos</h5>
                                <p>{{ $activity->resource_assignment }}</p>
                            @endif

                            @if($activity->example_assignment)
                                <hr>
                                <h5 class="text-muted">Asignación de Ejemplos</h5>
                                <p>{{ $activity->example_assignment }}</p>
                            @endif
                        </div>
                        <div class="col-md-4">
