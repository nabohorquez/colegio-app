...
@section('title', 'Crear Empleado - AcademicSoftware')
...
<div class="container mt-5">
    ...
    <form action="{{ route('employees.create') }}" method="POST" id="formCreateEmployee">
        @csrf
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('employees.index') }}" class="btn btn-secondary me-2">Cancelar</a>
