...
<?php $__env->startSection('title', 'Empleados - AcademicSoftware'); ?>
...
<?php $__env->startSection('content-principal'); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <?php endif; ?>
                        <td><?php echo e($employee->user->full_name ?? $employee->user->name); ?></td>
                        <td><?php echo e($employee->user->email); ?></td>
                        <td><?php echo e($employee->user->username); ?></td>
    ...
    <?php if(in_array('create', $permissions)): ?>
        <a href="<?php echo e(route('employees.viewCreate')); ?>"
...
<?php echo $__env->make('layouts.app-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Propios\colegio-app\resources\views/employees/index.blade.php ENDPATH**/ ?>