...
<?php $__env->startSection('title', 'Acudientes - AcademicSoftware'); ?>
    ...
    <table class="table table-bordered" id="guardiansTable">
        ...
        <?php $__currentLoopData = $guardians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guardian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                    ...
                    <td class="d-flex justify-content-center">
                        <?php if(in_array('edit', $permissions)): ?>
                            <button
                                ...
                                title="Editar"
                                data-id="<?php echo e($guardian->id); ?>">
                ...
                <td><?php echo e($guardian->first_name); ?> <?php echo e($guardian->last_name); ?></td>
                <td><?php echo e($guardian->email); ?></td>
                <td><?php echo e($guardian->gender); ?></td>
                <td><?php echo e($guardian->marital_status); ?></td>

                
                <td class="text-center">
                    <?php $count = $guardian->students->count(); ?>
                    <?php if($count > 0): ?>
                        <button
                            class="btn btn-link p-0 badge-button"
                            data-id="<?php echo e($guardian->id); ?>"
                            title="Ver estudiantes">
                            <span class="badge rounded-pill bg-primary"><?php echo e($count); ?></span>
                        </button>
                    <?php else: ?>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    ?>
    const studentsData = <?php echo json_encode($studentsArray, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\colegio-app\resources\views/guardians/index.blade.php ENDPATH**/ ?>