...
<?php $__env->startSection('content-principal'); ?>
    <div class="main-content p-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <h1 class="h3 text-dark">¡Bienvenido, <?php echo e(Auth::user()->name); ?>!</h1>
        ...
        <div class="row mb-4">
            ...
            <?php if(session('error')): ?>
                <div class="col-12 alert alert-danger"><?php echo e(session('error')); ?></div>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.app-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\colegio-app\resources\views/dashboard.blade.php ENDPATH**/ ?>